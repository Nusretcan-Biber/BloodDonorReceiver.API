...
namespace BloodDonorReceiver.DataAccess.Migrations
{
    ...
    [Migration("20240520192419_AddReceiversCitiesModelTable")]
    partial class AddReceiversCitiesModelTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BloodDonorReceiver.Data.Models.DonorsCitiesModel", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DonorsGuid");

                    b.ToTable("DonorsCities");
                });
            ...
            modelBuilder.Entity("BloodDonorReceiver.Data.Models.ReceiversCitiesModel", b =>
                {
                    b.Property<Guid>("Guid")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("ReceiversGuid");

                    b.ToTable("ReceiversCities");
                });
            ...
            modelBuilder.Entity("BloodDonorReceiver.Data.Models.DonorsCitiesModel", b =>
                {
                    b.HasOne("BloodDonorReceiver.Data.Models.CityModel", "City")
                        .WithMany("DonorsCities")
                        .HasForeignKey("CitysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("CitysId");

                    b.HasOne("BloodDonorReceiver.Data.Models.DonorModel", "Donor")
                        .WithMany("DonorsCities")
                        .HasForeignKey("DonorsGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("DonorsGuid");
            ...
            modelBuilder.Entity("BloodDonorReceiver.Data.Models.ReceiversCitiesModel", b =>
                {
                    b.HasOne("BloodDonorReceiver.Data.Models.CityModel", "City")
                        .WithMany("ReceiversCities")
                        .HasForeignKey("CitysId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("CitysId");

                    b.HasOne("BloodDonorReceiver.Data.Models.ReceiverModel", "Receiver")
                        .WithMany("ReceiversCities")
                        .HasForeignKey("ReceiversGuid")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("ReceiversGuid");
            ...
            modelBuilder.Entity("BloodDonorReceiver.Data.Models.CityModel", b =>
                {
                    ...
                    b.Navigation("DonorsCities");

                    b.Navigation("ReceiversCities");
